...
```
# Generating the predictions for both Linear regression and Random Forest Model on the training data
...
```
# K-Nearest Algorithm for Attrition 
...
The accuracy and sensitivity is better and specificity is little decreased as compared to KNN model but better than the Random Forest Model.
      No Yes
  No  177   5
  Yes  17   18
...
```
# Reading the original test data for Attrition and generating the predictions of K-Nearest Neighbor model, Random Forest model, and Logistic Regression model

* MonthlyIncome_KNN = Predictions for K-Nearest Neighbor
* MonthlyIncome_RF = Predictions for Random Forest
* MonthlyIncome_GLM = Predictions for Logistic Regression
